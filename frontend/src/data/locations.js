export const locationData = {
  ...
  "Arunachal Pradesh": [
    ...
    "Upper Subansiri", "West Siang", "East Siang", "Siang",
    "Upper Siang", "Lower Siang", "Lower Dibang Valley",
    "Dibang Valley", "Anjaw", "Lohit", "Namsai",
  ...
  "Assam": [
    ...
    "Nagaon", "Nalbari", "Dima Hasao", "Sivasagar",
  ...
  "Chhattisgarh": [
    ...
    "Dhamtari", "Durg", "Gariaband", "Janjgir Champa",
    "Jashpur", "Kabirdham", "Kanker", "Kondagaon",
    "Korba", "Koriya", "Mahasamund", "Mungeli",
    "Narayanpur", "Raigarh", "Raipur", "Rajnandgaon",
...
"Rajasthan": [
  ...
  "Dholpur", "Didwana Kuchaman", "Dungarpur",
  "Hanumangarh", "Jaipur", "Jaipur Rural", "Jaisalmer",
  ...
  "Shahpura", "Sikar", "Sirohi", "Sri Ganganagar",
  "Tonk", "Udaipur"
],
...
"Uttar Pradesh": [
  "Agra", "Aligarh", "Prayagraj", "Ambedkar Nagar",
  "Amethi", "Amroha", "Auraiya", "Ayodhya",
  "Azamgarh", "Baghpat", "Bahraich", "Ballia",
  "Balrampur", "Banda", "Barabanki", "Bareilly",
  "Basti", "Bhadohi", "Bijnor", "Budaun",
  "Bulandshahr", "Chandauli", "Deoria", "Etah",
  ...
  "Kheri", "Kushinagar", "Lucknow", "Maharajganj",
  "Mainpuri", "Mathura", "Meerut", "Mirzapur",
...
"West Bengal": [
  ...
  "Howrah", "Jalpaiguri", "Jhargram", "Kalimpong",
  "Kolkata", "Malda", "Murshidabad", "Nadia",
  "North 24 Parganas", "Paschim Bardhaman",
